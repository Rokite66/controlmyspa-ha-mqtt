...
class App extends EventEmitter {
  ...
  sensorsDiscovery(spa) {
    ...
    self.buttonDiscovery(spa, "Set Temperature Range High", "mdi:thermometer-lines", "tempRangeHigh", "HIGH");
    self.buttonDiscovery(spa, "Set Temperature Range Low", "mdi:thermometer-lines", "tempRangeLow", "LOW");
